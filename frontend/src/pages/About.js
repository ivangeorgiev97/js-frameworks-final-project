    ...
    return <>
        <div className="row">
            <div className="col-12">
                ...
                <hr className="hr" />
                <p><FontAwesomeIcon icon={faQuestion} className="mr-2"/> Предоставя възможност за създаване, преглеждане, изтриване, филтриране и сортиране на бележки със спомени, със заглавие и описание на всеки спомен.</p>
